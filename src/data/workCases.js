...
export const workCases = [
  ...
  },
  {
    ...
    title: "ReCenter, Rust 🌿",
    description:
      "Een mix van spontane UGC en stijlvolle testimonials die ook bedrijven warm maakt voor een retreat.",
    categories: ["Video & campagnes", "Social content", "Marketingstrategie"],
    image: "/work/recenter-work-thumb.jpg",
    imagePosition: "50% 42%",
    href: "/work/recenter/",
    featured: false,
    status: "ready",
  },
  {
    client: "Opnieuw & Co",
    slug: "opnieuw-en-co",
    title: "Oude spullen, een nieuwe look.",
    description:
      "Zomer- en wintercampagnes die tweedehandsspullen elk jaar opnieuw fris in de kijker zetten.",
    categories: ["Design & branding", "Marketingstrategie"],
    image: "/work/opnieuw-en-co-work-thumb.webp",
    imagePosition: "50% 18%",
    href: "/work/opnieuw-en-co/",
    featured: false,
    status: "ready",
  },
  {
    ...
    description:
      "Aftermovies, productvideo, interviews en teamcontent uit dezelfde draaidag.",
    categories: ["Video & campagnes", "Social content", "Marketingstrategie"],
    image: "/work/craftails-work-thumb.jpg",
    href: "/work/craftails/",
    featured: false,
    status: "ready",
  },
  {
    ...
    description:
      "Een emotionele terugblik op tien jaar ondernemen, met het jubileumfeest als verdiende finale.",
    categories: ["Video & campagnes", "Fotografie"],
    image: "/work/shopwedo-work-thumb.jpg",
    href: "/work/shopwedo/",
    featured: false,
    status: "ready",
  },
  ...
  },
  {
    ...
    description:
      "Een vaste creatieve partner waarop VDAB kan terugvallen voor jobbeurzen, events en fotografie.",
